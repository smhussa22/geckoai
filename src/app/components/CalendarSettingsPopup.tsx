  ...
  return (
    <div className="w-full">
      <div className="relative flex">
        <div>
          <h1 className="text-asparagus text-2xl font-bold tracking-tighter">Calendar Settings</h1>
      ...
      {loading ? (
        ...
        <>
          <div className="space-y-2">
            ...
            <div className="flex flex-col gap-1">
              <label className="text-ghost ml-0.5 gap-1 text-xs">Calendar Description</label>
            ...
            <div className="flex flex-col gap-2">
              <label className="text-ghost ml-0.5 text-xs">Default Event Visibility</label>
                ...
                {Object.entries(ICONS).map(([key, Icon]) => (
                  <button
                    ...
                    className={`rounded-lg bg-neutral-800 p-1.5 transition-colors hover:bg-neutral-700 ${
                      selectedIconKey === key ? 'ring-asparagus ring-2' : 'ring-1 ring-neutral-800'
                    }`}
                  >

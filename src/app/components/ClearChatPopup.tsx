...
export default function ClearChatPopup({ onClose }: { onClose?: () => void }) {
    ...
    <div className="w-full">
      ...
      <div className="flex relative">
        ...
        <div>
          ...
          <h2 className="mb-2 font-semibold tracking-tighter text-broccoli">This can be done to free storage.</h2>

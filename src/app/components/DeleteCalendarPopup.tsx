		...
		<div className="w-full">
			...
			<div className="mt-6 flex items-center gap-3">
				...
				<button
					...
					className={`group w-1/2 flex items-center justify-center rounded-lg ${canDelete ? 'hover:bg-night hover:text-red-900 bg-red-900 text-night' : 'bg-neutral-800 h-12.5'} font-bold py-2 px-4 text-xl tracking-tighter transition-colors duration-200 disabled:opacity-60 disabled:cursor-not-allowed`}
					disabled={!canDelete}
				...
				>
					...
					<span className="relative flex items-center">
						...
						<span className={`ml-0 ${canDelete && 'group-hover:ml-2'} transition-all duration-300`}>Delete</span>

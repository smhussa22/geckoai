            ...
            >
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-green-400 font-medium">Green</span> – Operational
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="h-3 w-3 rounded-full bg-yellow-400 shadow-[0_0_6px_2px_rgba(234,179,8,0.7)]" />
                    <span className="text-yellow-400 font-medium">Yellow</span> – Degraded / Partial outage
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="h-3 w-3 rounded-full bg-red-500 shadow-[0_0_6px_2px_rgba(239,68,68,0.7)]" />
                    <span className="text-red-400 font-medium">Red</span> – Major outage
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {[
                    { icon: <FaAws className="text-orange-400" size={18} />, label: "AWS S3 Cloud Storage" },
                    { icon: <FaStripeS className="text-indigo-400" size={18} />, label: "Stripe Payment" },
                    { icon: <FaGoogle className="text-red-500" size={18} />, label: "Google OAuth 2.0" },
                    { icon: <SiGooglecloud className="text-blue-400" size={18} />, label: "Google Cloud" },
                    { icon: <BiLogoPostgresql className="text-sky-500" size={18} />, label: "Neon Postgres Database" },
                  ].map((dep, i) => (
                    <motion.li
                      key={i}

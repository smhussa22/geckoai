    ...
    return (
        <div className="h-full w-full rounded-md border border-neutral-800 p-8 shadow-md">
            ...
            <p className="mb-8 max-w-2xl text-neutral-300">
                Here are some useful resources to help you get started with GeckoAI or explore the
            ...
            <div className="grid gap-6 md:grid-cols-2">
                ...
                >
                    ...
                    <p className="text-sm leading-snug text-neutral-300">
                        Watch a step-by-step walkthrough of GeckoAI’s features and learn how to make
                ...
                >
                    ...
                    <p className="text-sm leading-snug text-neutral-300">
                        Explore the full GeckoAI codebase, contribute, or check out how everything
